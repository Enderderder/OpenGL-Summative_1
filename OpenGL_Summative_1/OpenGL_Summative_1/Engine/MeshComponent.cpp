...
void CMeshComponent::RenderMesh(CCamera* _camera)
{
	...
	glm::vec3 objPos = this->m_gameObject->m_transform.position;
	glm::vec3 objRotate = this->m_gameObject->m_transform.rotation;
	glm::vec3 objScale = this->m_gameObject->m_transform.scale;
